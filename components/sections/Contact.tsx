      ...
      <div className="mt-16 grid grid-cols-1 gap-12 border-t border-ink/10 pt-12 md:mt-24 md:grid-cols-12">
        ...
        <Reveal className="flex flex-col gap-8 md:col-span-4 md:col-start-9">
          ...
          <Magnetic>
            <TransitionLink
              href="/contact"
              className="group mt-2 inline-flex w-fit items-center gap-3 bg-ink px-7 py-3.5 text-sm font-medium text-paper transition-opacity duration-500 hover:opacity-90"
            >
              Start a project
